...
// Description: The remove friendship page of the application of Social Network
//////////////////// with JavaFX
/////////////////////////////// 80 COLUMNS WIDE ///////////////////////////////
...
/**
 * This class represents the remove friendship screen of the remove friendship
 * function of the network application
 * 
 * @author A-Team 21
 *
 */
public class FriendshipScreen extends Main {

  public static void setupAddFriendshipPage(String name) {
    HBox hbox = new HBox();
    VBox vbox = new VBox();
    Text text = new Text();
    text = new Text("Add Friendship");
      ...
      public void handle(ActionEvent event) {
        ...
        if (event.getSource() instanceof CheckBox) {
          ...
          for (int i = 0; i < checkBoxCollections.size(); i++) {
            ...
            Main.netWork.addFriendship(Main.netWork.getCenter(),
  ...
  /**
   * This method sets up the page of RemoveFriendship for user removing
   * friendship from current network
   * 
   * @param name Click Action
   */
  public static void setupRemoveFriendshipPage(String name) {
    HBox hbox = new HBox();
    VBox vbox = new VBox();
    Text text = new Text();
    text = new Text("Add Friendship");
      ...
      public void handle(ActionEvent event) {
        ...
        if (event.getSource() instanceof CheckBox) {
          ...
          for (int i = 0; i < checkBoxCollections.size(); i++) {
            ...
            Main.netWork.removeFriendship(Main.netWork.getCenter(),
                Main.netWork.getAllUsers().get(selcetedCheckBox));
